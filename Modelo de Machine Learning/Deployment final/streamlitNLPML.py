...
load_dotenv(dotenv_path='Modelo de Machine Learning/Deployment final/googlecloudkeys.env')
...
@st.cache_resource
def cargar_modelo():
    return spacy.load('Modelo de Machine Learning/Deployment final/modelo_ner_comida_experiencia')
...
subprocess.call(["python", "Modelo de Machine Learning/Deployment final/setup.py"])
...
with open('Modelo de Machine Learning/Deployment final/us-states.json') as f:
